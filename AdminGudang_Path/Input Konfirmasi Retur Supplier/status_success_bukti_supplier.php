...
<body>
    ...
    <div class="success-container">
        ...
        <div class="success-title">
            <p>Berhasil Mengirim Konfirmasi Retur</p>
        </div>

        <div class="success-line"></div>

        <div class="success-desc">
            Tanggapan dan bukti komunikasi dengan supplier telah berhasil disimpan.
            Data ini akan digunakan sebagai dasar proses tindak lanjut retur barang.
        </div>
