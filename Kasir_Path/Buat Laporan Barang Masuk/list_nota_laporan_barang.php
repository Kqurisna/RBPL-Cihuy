...
$query = mysqli_query($koneksi, "
   SELECT * FROM nota WHERE status_laporan!='selesai' ORDER BY tanggal_nota DESC
"); ?>
<!doctype html>
<html lang="id">
        ...
        <?php } else { ?>
            ...
            <div class="empty-container">
                ...
                <div class="empty-title">
                    Belum ada laporan barang masuk
                </div>

                <div class="empty-line"></div>

                <div class="empty-desc">
                    Barang belum dapat ditampilkan karena belum dilakukan pengecekan fisik oleh <strong>Kasir Toko</strong>,
                    sehingga nota belum tersedia
                </div>
            </div>
