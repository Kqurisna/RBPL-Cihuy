...
if ($dataNota['status_laporan'] !== 'disetujui') {
    die("Nota belum disetujui, tidak bisa diakses sebagai arsip!");
}
...
">
                    ...
                    <?php } elseif ($dataNota['status_laporan'] === 'disetujui') { ?>
                        ...
                        Laporan telah disetujui dan siap untuk diarsipkan oleh
                ...
                <?php if ($dataNota['status_laporan'] === 'disetujui') { ?>
