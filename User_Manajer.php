  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="welcome-card">
        ...
        <h3>Selamat Datang, Manajer Toko</h3>
        <p>
          Tinjau dan validasi laporan barang masuk untuk memastikan akurasi sebelum diarsipkan
        </p>
      ...
      <div class="menu-card">
        <div class="menu-left">
          <div class="menu-icon">
            <img src="UI_MANAJER/logo_outbox_manajer.png" alt="" />
          </div>
